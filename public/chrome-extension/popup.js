class LeadFinderExtension {
  constructor() {
    this.apiBase = "http://localhost:3000" // Change to production URL when deployed
    this.token = null
    this.user = null
  ...
  async handleSignup() {
    ...
    try {
      ...
      this.showSuccess("Account created! Please check your email to verify your account, then sign in.")
      ...
      container.innerHTML = results
        ...
        <div class="result-item">
          ...
          <div class="result-details">
            ...
            ${result.website ? `🌐 <a href="${result.website}" target="_blank">${result.website}</a><br>` : ""}
            ${result.rating ? `⭐ ${result.rating} (${result.user_ratings_total || 0} reviews)` : ""}
          </div>
        </div>
      `,
        )
