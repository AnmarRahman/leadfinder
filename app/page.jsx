        ...
        <section className="py-24 px-4 bg-gradient-to-br from-background via-background to-muted/30">
          <div className="container max-w-6xl mx-auto text-center">
            ...
            <p className="text-sm text-muted-foreground max-w-2xl mx-auto">
              Not on the Chrome Web Store yet. Download the ZIP, then open <span className="font-semibold">chrome://extensions</span>,
              enable <span className="font-semibold">Developer mode</span>, click <span className="font-semibold">Load unpacked</span>,
              and select the unzipped <span className="font-semibold">public/chrome-extension</span> folder.
            </p>
            ...
            <div className="relative max-w-5xl mx-auto mt-10">
              <div className="aspect-video bg-gradient-to-br from-muted to-muted/50 rounded-2xl border-2 border-dashed border-border flex items-center justify-center shadow-2xl">
                <div className="text-center">
                  ...
                  <p className="text-xl font-semibold text-muted-foreground">Extension Demo Video</p>
                  <p className="text-sm text-muted-foreground mt-2">Upload your demo video here</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card className="text-center border-2 hover:border-primary/20 transition-all duration-300 hover:shadow-lg">
                <CardContent className="pt-12 pb-8">
                  ...
                  <p className="text-muted-foreground text-lg leading-relaxed">
                    Click the extension on any site to extract emails, phones and lead data.
                  </p>
                </CardContent>
              </Card>
        ...
        <section className="py-24 bg-background">
          <div className="container max-w-6xl mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              ...
              <div className="space-y-2">
                <div className="text-4xl md:text-5xl font-bold text-primary mb-3">1M+</div>
              ...
              <div className="space-y-2">
                ...
                <div className="text-muted-foreground text-lg">Accuracy Rate</div>
              </div>
              <div className="space-y-2">
