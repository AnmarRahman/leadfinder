          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <div className="flex items-center gap-2">
                <Badge variant={profile?.subscription_tier === "free" ? "secondary" : "default"} className="capitalize">
      ...
      <Card className="mt-6">
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="text-center p-4 border rounded">
              <p className="text-2xl font-bold">{(profile?.monthly_quota || 100) - (profile?.used_quota || 0)}</p>
